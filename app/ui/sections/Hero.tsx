...
function Hero({}: Props) {
  ...
  return (
    <div className="flex h-[calc(100vh-108px)] flex-col items-center justify-center space-y-8 overflow-hidden bg-gradient-radial from-[#151d3a] to-[#111729] text-center md:h-screen">
      <BackgroundCircles />
      <Image
